...
public class Testpayment {
	...
	public static void main(String[] args) throws InterruptedException
	{
		//launch browser and site
				...
				Thread.sleep(5000);
				//click on payment
				driver.findElement(By.xpath("//*[@href='/amweb/spayment']")).click();
				Thread.sleep(3000);
				//fill fields
				driver.findElement(By.xpath("//*[@name='pname']")).sendKeys("shahrukh");
				driver.findElement(By.xpath("//*[@name='pemail']")).sendKeys("shahrukh@");
				driver.findElement(By.xpath("//*[@name='pphoneno']")).sendKeys("1234567890");
