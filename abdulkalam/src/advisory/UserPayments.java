...
public class UserPayments {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		//click on payment
		driver.findElement(By.xpath("//*[@href='/advisory/payments']")).click();
		Thread.sleep(3000);
		//fill fields
		driver.findElement(By.xpath("//*[@placeholder='Your name']")).sendKeys("shahrukh");
		driver.findElement(By.xpath("//*[@placeholder='Your Email Address']")).sendKeys("shahrukh@gmail.com");
		driver.findElement(By.xpath("//*[@placeholder='Your Phone Number (optional)']")).sendKeys("8756436789");
		driver.findElement(By.xpath("//*[@placeholder='Your Web Site (optional)']")).sendKeys("google");
		driver.findElement(By.xpath("//*[@placeholder='Type your message here....']")).sendKeys("ashdgwqyg jashgd7w nsgdqwd ahasashwqd bhudhqw");
		driver.findElement(By.xpath(".//*[@href='https://www.instamojo.com/@ProdesignTechnologies/']")).click();
