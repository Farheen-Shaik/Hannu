...
public class Log4j {
	...
	public void test(String[] args) throws BiffException, IOException, InterruptedException, RowsExceededException, WriteException 
	{
		File f=new File("C:\\karishma\\xml5.xls");
