...
public class Ac {
	...
	public static void main(String[] args) throws BiffException, IOException, InterruptedException, AWTException, RowsExceededException, WriteException 
	
	{
		File f=new File("C:\\karishma\\haseen6.xls");
		...
		//asset file
		File f1=new File("C:\\karishma\\raafi6.xls");
