...
public class Weekpaydetails {
	...
	public static void main(String[] args) throws InterruptedException
	{
		//launch browser and site
				...
				driver.findElement(By.xpath(".//*[@id='tab2default']/div/div/div[1]/table/tbody/tr[3]/td[12]/button")).click();
				Thread.sleep(5000);
				//maximize window
				driver.manage().window().maximize();
				...
				Thread.sleep(5000);
				//To scroll down
	             /*WebElement e1=driver.findElement(By.xpath("//*[@class='btn dropdown-toggle']"));
	             JavascriptExecutor j= (JavascriptExecutor) driver;
	             j.executeScript("arguments[0].scrollIntoView();", e1);
                 Thread.sleep(5000);*/
				//click on hello balaji
				driver.findElement(By.xpath("//*[@class='btn dropdown-toggle']")).click();
				//click on logout
